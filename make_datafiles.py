...
cnn_tokenized_stories_dir = "wru_content_summarizer_app/pointer-generator/cnn_stories_tokenized"
dm_tokenized_stories_dir = "dm_stories_tokenized"
finished_files_dir = "wru_content_summarizer_app/pointer-generator/chunked"
chunks_dir = os.path.join(finished_files_dir, "quint")
...
def chunk_file(set_name):
  in_file = 'wru_content_summarizer_app/pointer-generator/chunked/%s.bin' % set_name
...
def write_to_bin(out_file, makevocab=False):
  ...
  with open(out_file, 'wb') as writer:
    for idx,s in enumerate(story_fnames):
      ...
      article, abstract = get_art_abs('wru_content_summarizer_app/pointer-generator/cnn_stories_tokenized/quint.story')
...
if __name__ == '__main__':
  if len(sys.argv) != 2:
    print "USAGE: python make_datafiles.py <cnn_stories_dir>"
    sys.exit()
